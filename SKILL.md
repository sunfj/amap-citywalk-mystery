...
```bash
node scripts/api-client.js poi "博物馆" "杭州"
node scripts/api-client.js route "120.14873,30.25954" "120.15000,30.26000"
node scripts/api-client.js weather 杭州
...
```bash
# 生成打卡链接
node scripts/api-client.js checkin "纯真年代书吧" 30.25954 120.14873
# 输出: {"sessionId":"abc123","checkinUrl":"https://..."}
```
...
```bash
# 阶段0：批量查询 POI 题目
node scripts/api-client.js questions "B0FFHU6VO0,B0FFJ3C780"

# 阶段0：为无题 POI 上传新题目
node scripts/api-client.js upload-questions '{"items":[{"poiId":"B0FFJ3C780",...}]}'

# 阶段4：答案校验
node scripts/api-client.js verify "q-xxx" "吉他" true
```
